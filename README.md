# MattMusicSDK
MattMusicSDK - MacOS and iOS audio player xcFrameworks with real-time data (sound samples for drawing the waveform, FFT real and complex results + spectrum bins and magnitudes, and significant spectral flux detection) for M4A, MP3, etc
