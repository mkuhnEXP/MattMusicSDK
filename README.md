# MattMusicSDK
MattMusicSDK - xcFrameworks for audio playback of MP3, M4A, etc + real-time data (sound samples for waveform, FFT real and imaginary results + spectrum bins & magnitudes, plus beat detection) for MacOS and iOS.
